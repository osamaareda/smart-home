...
# 12 "MCAL/INTERRUPT/mcal_external_interrupt.h"
# 1 "MCAL/INTERRUPT/mcall_interrupt_cfg.h" 1
# 12 "MCAL/INTERRUPT/mcall_interrupt_cfg.h"
...
# 12 "MCAL/INTERRUPT/mcall_interrupt_cfg.h" 2

# 1 "MCAL/INTERRUPT/mcal_interrupt_gen_cfg.h" 1
# 13 "MCAL/INTERRUPT/mcall_interrupt_cfg.h" 2

# 1 "MCAL/INTERRUPT/../GPIO/gpio.h" 1
# 13 "MCAL/INTERRUPT/../GPIO/gpio.h"
# 1 "MCAL/INTERRUPT/../GPIO/mcal_gpio_cfg.h" 1
# 13 "MCAL/INTERRUPT/../GPIO/gpio.h" 2

# 1 "MCAL/INTERRUPT/../GPIO/../device_config.h" 1
# 14 "MCAL/INTERRUPT/../GPIO/gpio.h" 2
...
# 14 "MCAL/INTERRUPT/mcall_interrupt_cfg.h" 2
# 51 "MCAL/INTERRUPT/mcall_interrupt_cfg.h"
typedef enum{
   LOW_PRIORITY,
   HIGH_PRIORITY
}interrupt_priority_t;
# 12 "MCAL/INTERRUPT/mcal_external_interrupt.h" 2
...
# 57 "MCAL/INTERRUPT/mcal_external_interrupt.c"
Std_ReturnType interrupt_INTx_init( interrupt_INTx_t *_interrupt){

    Std_ReturnType ret=(Std_ReturnType)0x00;
    if(((void*)0)==_interrupt){
...
# 304 "MCAL/INTERRUPT/mcal_external_interrupt.c"
static Std_ReturnType interrupt_INTx_edge_init(interrupt_INTx_t *_interrupt){
    ...
    if(((void*)0)==_interrupt){
        ...
        switch(_interrupt->source){
            case _INT0 :
                if(RISING_EDGE==_interrupt->edge){ (INTCON2bits.INTEDG0=1);}
                else if (FALLING_EDGE==_interrupt->edge){(INTCON2bits.INTEDG0=0);}
                ret=(Std_ReturnType)0x01;
                break;
            case _INT1 :
                if(RISING_EDGE==_interrupt->edge){(INTCON2bits.INTEDG1=1);}
                else if (FALLING_EDGE==_interrupt->edge){(INTCON2bits.INTEDG1=0);}
                ret=(Std_ReturnType)0x01;
                break;
            case _INT2 :
                if(RISING_EDGE==_interrupt->edge){(INTCON2bits.INTEDG2=1);}
                else if (FALLING_EDGE==_interrupt->edge){(INTCON2bits.INTEDG2=0);}
                ret=(Std_ReturnType)0x01;
                break;
            default :
                ret=(Std_ReturnType)0x00;
...
# 456 "MCAL/INTERRUPT/mcal_external_interrupt.c"
Std_ReturnType interrupt_RBx_init(interrupt_RBx_t *_interrupt){
...
static Std_ReturnType interrupt_RBx_priority_init( interrupt_RBx_t *_interrupt){
        Std_ReturnType ret=(Std_ReturnType)0x00;
# 581 "MCAL/INTERRUPT/mcal_external_interrupt.c"
        (INTCONbits.GIE=1);
        (INTCONbits.PEIE=1);
