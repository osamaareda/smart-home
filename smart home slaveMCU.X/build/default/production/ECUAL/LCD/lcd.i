...
# 1 "ECUAL/LCD/lcd.h" 1
# 12 "ECUAL/LCD/lcd.h"
# 1 "ECUAL/LCD/../../MCAL/GPIO/gpio.h" 1
# 12 "ECUAL/LCD/../../MCAL/GPIO/gpio.h"
# 1 "ECUAL/LCD/../../MCAL/GPIO/../mcal_std_types.h" 1
# 12 "ECUAL/LCD/../../MCAL/GPIO/../mcal_std_types.h"
# 1 "ECUAL/LCD/../../MCAL/GPIO/../compiler.h" 1
# 12 "ECUAL/LCD/../../MCAL/GPIO/../compiler.h"
...
# 12 "ECUAL/LCD/../../MCAL/GPIO/../compiler.h" 2
# 12 "ECUAL/LCD/../../MCAL/GPIO/../mcal_std_types.h" 2

# 1 "ECUAL/LCD/../../MCAL/GPIO/../std_libraries.h" 1
# 12 "ECUAL/LCD/../../MCAL/GPIO/../std_libraries.h"
...
# 12 "ECUAL/LCD/../../MCAL/GPIO/../std_libraries.h" 2
...
# 14 "ECUAL/LCD/../../MCAL/GPIO/../std_libraries.h" 2
# 13 "ECUAL/LCD/../../MCAL/GPIO/../mcal_std_types.h" 2
...
# 12 "ECUAL/LCD/../../MCAL/GPIO/gpio.h" 2

# 1 "ECUAL/LCD/../../MCAL/GPIO/mcal_gpio_cfg.h" 1
# 13 "ECUAL/LCD/../../MCAL/GPIO/gpio.h" 2

# 1 "ECUAL/LCD/../../MCAL/GPIO/../device_config.h" 1
# 14 "ECUAL/LCD/../../MCAL/GPIO/gpio.h" 2
...
# 12 "ECUAL/LCD/lcd.h" 2

# 1 "ECUAL/LCD/ecual_lcd_cfg.h" 1
# 13 "ECUAL/LCD/lcd.h" 2
# 43 "ECUAL/LCD/lcd.h"
typedef struct{
    pin_config_t lcd_rs;
    pin_config_t lcd_en;
...
Std_ReturnType lcd_init(lcd_config_t *lcd){
    ...
    Std_ReturnType gpio_ret=(Std_ReturnType)0x00;
    Std_ReturnType lcd_ret=(Std_ReturnType)0x00;
    uint8 pins_counter;
    if(((void*)0)==lcd){
        ...
        lcd_ret=lcd_send_command(lcd, 0x38);
        _delay((unsigned long)((5)*(8000000/4000.0)));
        lcd_ret=lcd_send_command(lcd, 0x38);
        _delay((unsigned long)((150)*(8000000/4000.0)));
        lcd_ret=lcd_send_command(lcd, 0x38);

        lcd_ret=lcd_send_command(lcd, 0X01);
        lcd_ret=lcd_send_command(lcd, 0x02);
        lcd_ret=lcd_send_command(lcd, 0x06);
        lcd_ret=lcd_send_command(lcd, 0x0C);
        lcd_ret=lcd_send_command(lcd, 0x80);

        lcd_ret=lcd_send_command(lcd, 0x28);
...
Std_ReturnType lcd_send_string_pos(lcd_config_t *lcd, uint8 row, uint8 column, uint8 *str){
    ...
    Std_ReturnType gpio_ret=(Std_ReturnType)0x00;
    Std_ReturnType lcd_ret=(Std_ReturnType)0x00;
    if(((void*)0)==lcd || ((void*)0)==str || row>4 || column>40){
        ret=(Std_ReturnType)0x00;
    }
    else{
        lcd_ret=lcd_set_curser(lcd,row,column);
...
Std_ReturnType lcd_send_custom_char(lcd_config_t *lcd, uint8 row, uint8 column,
    ...
    if(((void*)0)==lcd || row>4 || column>20){
        ...
        lcd_ret=lcd_send_command(lcd,(0x40 +(mem_pos*8)));
...
static Std_ReturnType lcd_set_curser(lcd_config_t *lcd, uint8 row, uint8 column){
 ...
 column--;
    ...
    switch(row){
        case 1 :lcd_ret=lcd_send_command(lcd, 0x80+column); break;
        case 2 :lcd_ret=lcd_send_command(lcd, 0xc0+column); break;
        case 3 :lcd_ret=lcd_send_command(lcd, 0x94+column); break;
        case 4 :lcd_ret=lcd_send_command(lcd, 0xd4+column); break;
    }
