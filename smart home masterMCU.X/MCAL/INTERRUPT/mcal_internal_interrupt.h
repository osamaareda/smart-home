...
//==========CCP1 INTERRUPT========//
#if CCP1_INTERRUPT_FEATURE==ENABLE
...
//==========CCP2 INTERRUPT========//
#if CCP2_INTERRUPT_FEATURE==ENABLE
...
//==========I2C INTERRUPT========//
#if I2C_INTERRUPT_FEATURE==ENABLE
...
#if I2C_BUS_COL_INTERRUPT_FEATURE==ENABLE
/* This routine sets the interrupt enable for the I2C_BUS_COL Module */
#define I2C_BUS_COL_InterruptEnable()    (PIE2bits.BCLIE = 1)
/* This routine clears the interrupt enable for the I2C_BUS_COL Module */
#define I2C_BUS_COL_InterruptDisable()   (PIE2bits.BCLIE = 0)
/* This routine clears the interrupt flag for the I2C_BUS_COL Module */
#define I2C_BUS_COL_InterruptFlagClear() (PIR2bits.BCLIF = 0)
#if INTERRUPT_PRIORITY_LEVELS==ENABLE 
/* This routine set the I2C_BUS_COL Module Interrupt Priority to be High priority */
#define I2C_BUS_COL_HighPrioritySet()    (IPR2bits.BCLIP = 1)
/* This routine set the I2C_BUS_COL Module Interrupt Priority to be Low priority */
